...
# python3 scripts/export_trt_freespace.py --onnx='./weights/sam_freespace_encoder_folded.onnx' --trt='./weights/sam_freespace_encoder_folded.trt'
python3 scripts/export_trt_freespace.py --onnx='./weights/sam_freespace_decoder_folded.onnx' --trt='./weights/sam_freespace_decoder_folded.trt'
